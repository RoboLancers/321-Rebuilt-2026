...
public class DemoShoot extends Command {
  ...
  public DemoShoot(Tunnel tunnel, Shooter shooter, Indexer indexer) {
    this.tunnel = tunnel;
  ...
  public void execute() {
    ...
    shooter.goToVelocity(OuttakeConstants.kDemoShootVelocity);
    indexer.goToVelocity(IndexerConstants.kIndexVelocity);

    shooter.setTargetVelocity(OuttakeConstants.kDemoShootVelocity);
