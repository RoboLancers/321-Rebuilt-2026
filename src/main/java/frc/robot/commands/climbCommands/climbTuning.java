...
public class climbTuning {
    ...
    public climbTuning(Climb climb, ArmFeedforward armFeedforward, PIDController climbController, TunableConstant kP, TunableConstant kD, TunableConstant kG, TunableConstant targetAngle) {
