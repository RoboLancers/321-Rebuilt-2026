...
public class DemoShooting extends Command {

  Tunnel tunnel;
  Shooter shooter;
  Indexer indexer;

  public DemoShooting(Tunnel tunnel, Shooter shooter, Indexer indexer) {
    this.tunnel = tunnel;
  ...
  public void execute() {
    ...
    shooter.goToVelocity(OuttakeConstants.kDemoVelocity);
    indexer.goToVelocity(IndexerConstants.kIndexVelocity);

    shooter.setTargetVelocity(OuttakeConstants.kDemoVelocity);
