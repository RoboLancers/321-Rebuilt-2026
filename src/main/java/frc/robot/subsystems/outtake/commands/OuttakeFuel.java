...
public static Command outtakeWithVoltage(Outtake outtake, Voltage volts){
    return outtake.runVolts(volts);
}

public static Command outtakeWithVelocity(Outtake outtake, AngularVelocity rpm){
    return outtake.setControl(rpm);
}
